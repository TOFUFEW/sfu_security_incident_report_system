...
export class LocationModalComponent implements OnInit {     
    @ViewChild(LocationComponent) locationComponent: LocationComponent     
        ...
        // this.reportService.addIncidentElement( this.locationComponent.newLocation, Config.LocationTable );                this.locationSaved.emit('complete');         this.hide();     }         ngOnInit() {         // Hide the remove location button from the location component         document.getElementById("removeLocation").style.visibility = "hidden";     } }
