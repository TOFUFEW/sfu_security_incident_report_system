...
Config.serverURL = "https://localhost:4567/";
//private static serverURL: string = "https://cmpt373-1177a.cmpt.sfu.ca:4567/";
Config.LocationsURI = Config.serverURL + "locations";
Config.IncidentsURI = Config.serverURL + "incidents";
Config.FTSearchURI = Config.serverURL + "ftsearch-incident";
Config.CTSearchURI = Config.serverURL + "ctsearch-incident";
Config.StaffURI = Config.serverURL + "staff";
Config.LoginURI = Config.serverURL + "login";
Config.PersonURI = Config.serverURL + "person";
Config.GetIncidentsURI = Config.serverURL + "get-incidents";
Config.GetIncidentURI = Config.serverURL + "get-incident";
Config.CreatedIncidentsURI = Config.serverURL + "created-incidents";
Config.CategoriesURI = Config.serverURL + "categories";
Config.UpdateIncidentURI = Config.serverURL + "update-incident";
Config.UploadURI = Config.serverURL + "upload";
Config.TimerURI = Config.serverURL + "timer";
Config.UploadsURI = Config.serverURL + "uploads";
Config.GetFileURI = Config.serverURL + "upload/get/";
Config.NewAccountURI = Config.serverURL + "create-account";
Config.GetAccountTypesURI = Config.serverURL + "get-account-types";
Config.GetCampusURI = Config.serverURL + "campus";
Config.ValidateUsernameURI = Config.serverURL + "validate-username";
Config.PersonExistsURI = Config.serverURL + "person-exists";
