...
public class TestIncident
{
    ...
    @Test
    public void testInsertIncidentRefactor () {
        ...
        incident1.updateAttributeValue ( Column.TEMPORARY_REPORT, "1");
    ...
    public void testInsertIncident ()
    {
        ...
        int currentSize = getNumberOfIncidents ();
        Assert.assertTrue( DBHelper.insertIncident( incident1 ) != null );
    ...
    @Test
    public void testUpdateIncidentRefactor() {
        Incident[] incidents = DBHelper.getIncidents();
        IncidentElement[] categories = DBHelper.getIncidentElements( DatabaseValues.Table.INCIDENT_CATEGORY );
        IncidentElement[] staffList = DBHelper.getIncidentElements( DatabaseValues.Table.STAFF );
        ...
        incident1.updateAttributeValue ( Column.EXECUTIVE_SUMMARY, "TEST SUMMARY" );
        incident1.updateAttributeValue ( Column.STATUS, "0" );
        incident1.updateAttributeValue ( Column.TEMPORARY_REPORT, "0");
        incident1.updateAttributeValue ( Column.TIMER_START, "155555555");
        incident1.updateAttributeValue ( Column.TIMER_END, "166666666");
    ...
    public void testAssignGuardToNewIncident() {
        ...
        Assert.assertTrue( DBHelper.insertIncident ( newIncident ) != null );
        Assert.assertTrue( currentSize < getNumberOfIncidents() );
    ...
    public void testInsertWithNonExistingAccountId() {
        ...
        Assert.assertFalse( DBHelper.insertIncident( incident1 ) != null );
    }
